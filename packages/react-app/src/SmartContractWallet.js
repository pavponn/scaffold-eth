...
export default function SmartContractWallet(props) {
    ...
    if (props.address === owner) {
        ownerDisplay.push(
            <Row align="middle" gutter={4}>
                ...
                <Col span={6}>
                    <Button style={{marginLeft: 4}} onClick={updateFriend(true)} shape="circle"
                            icon={<CheckCircleOutlined/>}/>
                    <Button style={{marginLeft: 4}} onClick={updateFriend(false)} shape="circle"
        ...
        ownerDisplay = (
            <Row align="middle" gutter={4}>
                <Col span={8}
                     style={{textAlign: "right", opacity: 0.333, paddingRight: 6, fontSize: 24}}>Recovery:</Col>
                <Col span={16}>
                    {recoverDisplay}
                </Col>
            </Row>
    ...
    return (
        <div>
            ...
            <List
                style={{width: 550, marginTop: 25, overflowY: "scroll"}}
