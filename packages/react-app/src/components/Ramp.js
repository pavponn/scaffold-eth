    ...
    return (
        <div>
            ...
            <Modal
                ...
                footer={[<Button key="back" onClick={() => setModalUp("down")}>cancel</Button>]}
            >
                <p><Button type={type} size="large" shape="round" onClick={() => {
                    ...
                    <span role="img" aria-label="USA flag" style={{paddingRight: 15}}>🇺🇸</span>Wyre
                </Button></p>
                <p><Button type={type} size="large" shape="round" onClick={() => {
                    new RampInstantSDK({
                    ...
                    <span role="img" aria-label="GBR flag" style={{paddingRight: 15}}>🇬🇧</span>Ramp
                </Button></p>

                <p>
                    <Button type={type} size="large" shape="round" onClick={() => {
                        window.open("https://www.coinbase.com/buy-ethereum")
                    }}>
                        <span role="img" aria-label="Bank emoji" style={{paddingRight: 15}}>🏦</span>Coinbase
                    </Button>
                </p>
